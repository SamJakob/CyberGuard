...
class RootAppBar extends StatefulWidget {
  ...
  RootAppBar({
    ...
    this.forceShrink = false,
        ...
        expandedHeight =
            forceShrink ? collapsedHeight : expandedHeight + (bottomWidget != null ? bottomWidgetSize ?? 0 : 0),
        super(key: key);
...
class _RootAppBarState extends State<RootAppBar> {
  final shrinkController = _RootAppBarShrinkController(initialScrollProgress: 1.0);
          ...
          child: LayoutBuilder(
            builder: (final context, final constraints) {
              final double scrollProgress = (() {
                ...
                // heights.
                return ((constraints.maxHeight - widget.collapsedHeight - (widget.bottomWidgetSize)) /
                        (widget.expandedHeight - widget.collapsedHeight - (widget.bottomWidgetSize)))
                    .clamp(0.0, 1.0);
              })();
              ...
              return Stack(
                ...
                children: [
                  FadeTransition(
                    opacity: AlwaysStoppedAnimation<double>(const Interval(0.0, 0.8).transform(scrollProgress)),
                          ...
                          Expanded(
                            child: Align(
                              ...
                              child: AnimatedContainer(
                                ...
                                padding: const EdgeInsets.symmetric(horizontal: kSpaceUnitPx * 1.5).copyWith(
                                  bottom: (kSpaceUnitPx + widget.bottomWidgetSize * 1 / shrinkController.scaleFactor) *
                                      0.85,
                                ),
                                child: Text(
                                  widget.title,
                  ...
                  FadeTransition(
                    opacity: AlwaysStoppedAnimation<double>(const Interval(0.8, 1.0).transform(1 - scrollProgress)),
                    child: Align(
              ...
              child: SizedBox(
                ...
                child: AnimatedContainer(
                  ...
                  padding: (widget.autoPadBottomWidget
                          ? EdgeInsets.symmetric(horizontal: kSpaceUnitPx * 1.5 * shrinkController.scaleFactor)
                          : EdgeInsets.zero)
                      .copyWith(bottom: kSpaceUnitPx * (shrinkController.scrollProgress)),
